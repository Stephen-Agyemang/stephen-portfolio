 ...
 *
 * A card's feed-band screenshot is `src/assets/projects/<id>.webp`, matched by
 * `id` — drop the file in and the card picks it up, no field needed here. A
 * project without one shows the offline-feed placeholder, so screenshots can
 * land one at a time.
 *
